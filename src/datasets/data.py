...
class TSRegressionArchive(BaseData):
    ...
    def load_single(self, filepath):
        ...
        if self.config['task'] == 'regression':
            df, labels = data_utils.load_from_tsfile_to_dataframe(filepath, return_separate_X_and_y=True, replace_missing_vals_with='NaN')
            ...
            try:
                ...
                df, _ = data_utils.load_from_tsfile_to_dataframe(filepath, return_separate_X_and_y=True,
                                                                 replace_missing_vals_with='NaN')
            labels_df = None
